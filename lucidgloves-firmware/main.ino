...
void loop() {
  if (comm->isOpen()){
    ...
    #if USING_IMU
    float* IMUdata = getIMU();
    comm->output(encode(fingerPos, getJoyX(), getJoyY(), joyButton, triggerButton, aButton, bButton, grabButton, pinchButton, calibButton, menuButton, IMUdata));
    #else
